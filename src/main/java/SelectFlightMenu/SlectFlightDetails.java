...
import javax.swing.event.DocumentListener;
 ...
 class SlectFlightDetails extends JDialog implements ItemListener, ActionListener {
	...
	public SlectFlightDetails(JFrame theParent, FlightFilter aFlightFilter) {
		super(theParent, "Define Filter");
		filter = aFlightFilter;
